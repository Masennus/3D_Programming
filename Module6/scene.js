...
$(function(){
	...
	if ( ruins.length == 5 ) 
		{
			...
			// Just a quick hack for the clouds.
			ruins[5].position.y = 5;
			ruins[5].scale.x = 30;
			ruins[5].scale.y = 30;
			ruins[5].scale.z = 30;
		}
	...
	// Repeat settings for the texture, i'm not sure was it meant to be done like this?
	pineTexture.wrapT = THREE.RepeatWrapping;
	pineTexture.wrapS = THREE.RepeatWrapping;
	// Repeat 7 times in x axis, and once in y. Leaving us to 7 trees in row.
	pineTexture.repeat.set(7, 1);
	...
	plane2.rotation.z = 3.15;
	plane2.rotation.y = 4.7;
	plane2.scale.y = 10;
	plane2.scale.x = 30;
	scene.add(plane2);
...
function displayFPS(){
    ...
    function cozyFire()
	{
		woodPile = new THREE.Object3D();
		woodPile.position.y = 0.2;
		woodPile.position.x = 0.2;
		wood1 = new THREE.Mesh(new THREE.CubeGeometry(0.6,0.2,0.2), new THREE.MeshLambertMaterial({ color: 0xCC9900, transparent: false}));
		wood1.rotation.z = -0.3;
		wood2 = new THREE.Mesh(new THREE.CubeGeometry(0.6,0.2,0.2), new THREE.MeshLambertMaterial({ color: 0xCC9900, transparent: false}));
		wood2.rotation.z = 0.3;
		wood2.position.x = -0.4;
		
		wood3 = new THREE.Mesh(new THREE.CubeGeometry(0.6,0.2,0.2), new THREE.MeshLambertMaterial({ color: 0xCC9900, transparent: false}));
		wood3.rotation.z = -0.3;
		wood3.rotation.y = 1;
		wood3.position.z = -0.3;
		
		wood4 = new THREE.Mesh(new THREE.CubeGeometry(0.6,0.2,0.2), new THREE.MeshLambertMaterial({ color: 0xCC9900, transparent: false}));
		wood4.rotation.z = 0.3;
		wood4.rotation.y = -1;
		wood4.position.z = -0.3;
		wood4.position.x = -0.3;
		
		wood5 = new THREE.Mesh(new THREE.CubeGeometry(0.6,0.2,0.2), new THREE.MeshLambertMaterial({ color: 0xCC9900, transparent: false}));
		wood5.rotation.z = 0.3;
		wood5.rotation.y = 1;
		wood5.position.z = 0.3;
		wood5.position.x = -0.3;
		
		wood6 = new THREE.Mesh(new THREE.CubeGeometry(0.6,0.2,0.2), new THREE.MeshLambertMaterial({ color: 0xCC9900, transparent: false}));
		wood6.rotation.z = 0.3;
		wood6.rotation.y = 2;
		wood6.position.z = 0.3;
